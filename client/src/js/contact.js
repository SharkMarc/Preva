...
export default class Contact extends React.Component {
	...
	handleContact() {
		...
		fetch("http://192.168.50.2/marcsblog/controller/contact.php", {
			method:  "POST",
	...
	render() {
		return (
			<div className="mt-5">
				...
				<div>
					<form role="form" onSubmit={this.handleContact} action="http://192.168.50.2/marcsblog/controller/contact.php"
